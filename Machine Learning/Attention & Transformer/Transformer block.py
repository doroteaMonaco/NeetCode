...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.self_attention = self.MultiHeadedSelfAttention(model_dim, num_heads)
        self.vanillaNN = self.VanillaNeuralNetwork(model_dim)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        embedded = embedded + self.self_attention(self.norm1(embedded))
        embedded = embedded + self.vanillaNN(self.norm2(embedded))
